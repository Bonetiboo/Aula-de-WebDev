...
console.log(5 > "6");  // false (deve ser menor que)
console.log(4 < "5"); // true (deve ser maior que)
console.log(5 >= "5"); // true (deve ser maior ou igual que)
console.log(5 <= "5");  // true (deve ser menor ou igual que)
